...
discard          : resolveDiscard NEWLINE discardAction+ discardDetails ;
resolveDiscard   : RESOLVING WORD INT CARDS ;
discardAction    : name IS WORD card NEWLINE ;
discardDetails   : NO MORE_ CARDS TO WORD NEWLINE (DISCARDED card NEWLINE)+ ;
