...
function Toast(){
    ...
    return (
        <>
            <div className={`flex fixed box-border -bottom-20 inset-x-1 justify-center z-30 ${visi ? 'opacity-100 transition-transform duration-500 -translate-y-20 ease-in-out' : 'opacity-0'}`}>
