...
function CardBase({card}) {
    ...
    return (
        <div className="relative flex flex-col w-24 h-16 sm:w-32 sm:h-24 m-2 border-2 border-scifi4 border-double rounded-sm bg-gradient-to-t from-scifi2 to-scifi3 hover:ring ring-scifi2">
