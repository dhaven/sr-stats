...
function CardBase({card}) {
    ...
    return (
        <div className="relative flex flex-col w-32 h-24 bg-slate-300 m-2 border-2 border-black border-double rounded-sm bg-gradient-to-t from-scifi2 to-scifi3 hover:ring ring-scifi2">
