    ...
    for(let key in decksData){
        ...
        for(let i = 0; i < 4; i++){
            ...
            if(i == 0 && blob_count != 0){
                ...
                classNames[key][i]['background'] = "rgb(163 230 53)"
    ...
    return (
        <div className={styles.container}>
            <div className={styles.line}>
                <p className="p-2">{winner} won !</p>
                <div className="p-2 w-24 h-20">
                        <svg fill="#0f8942" stroke="#0f8942" viewBox="0 0 166.88282 104.205" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-row h-4 w-1/2 m-2">
                    {
            ...
            <div className={styles.invert}>
                ...
                <div className="flex flex-row h-4 w-1/3 m-2">
                    {
